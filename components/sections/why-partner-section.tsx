        ...
        <div className="grid gap-4 md:grid-cols-2">
          {siteContent.partner.points.map((point, index) => (
            <Reveal key={point} delay={80 + index * 70}>
              <article className="interactive-card group relative overflow-hidden rounded-[1.25rem] border border-brand-burgundy/15 bg-white/80 p-5 text-brand-burgundy shadow-premium hover:border-brand-gold/55">
